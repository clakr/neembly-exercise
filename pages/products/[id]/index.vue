    ...
    <template v-else-if="product">
      ...
      >
        ...
        <div class="col-span-3 flex flex-col gap-y-4 h-full relative">
          ...
          <div class="absolute bottom-0 right-0 flex gap-x-2">
            <NuxtLink
              :to="`/products/${product.id}/edit`"
              class="border border-slate-300 p-2 rounded group hover:border-blue-400 transition-colors"
            >
              <span class="sr-only">Go To Edit Product Page</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                class="size-6 fill-slate-400 group-hover:fill-blue-400 transition-colors"
              >
                <path
            ...
            <button
              type="button"
              class="border border-slate-300 p-2 rounded group hover:border-red-400 transition-colors"
              @click="handleDeleteProduct"
            >
              <span class="sr-only">Delete Product Button</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
